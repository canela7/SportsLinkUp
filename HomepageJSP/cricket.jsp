...
<body>
  ...
  <div class="w3-content" style="max-width:2000px; margin-top:46px">
    ...
    <div class="mySlides w3-display-container w3-center">
      <img src="./HomepageContent/img/Cricket-1.jpg" style="width:100%" height="450">
    ...
    <div class="mySlides w3-display-container w3-center">
      <img src="./HomepageContent/img/Cricket-2.jpg" style="width:100%" height="450">
      <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
        <h3>New York</h3>
        <p>
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="app">
    ...
    <h1>Link Up!</h1>
    <a href="../Contact/ContactCricketInfo.html" class="button">Create Cricket Event</a>
