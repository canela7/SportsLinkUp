          ...
          <div class="col-lg-6">
            <a class="portfolio-item" href="Cricket">
              <span class="caption">
                <span class="caption-content">
                  <h1>Cricket</h1>
                  <h5 class="mb-0"><b>Let's Play!</b></h5>
                  <br>
                  <br>
                </span>
              </span>
    ...
    <footer class="footer text-center" id="contact">
      <div class="container">
        <ul class="list-inline mb-5">
          ...
          <li class="list-inline-item">
            <a class="social-link rounded-circle text-white" href="https://github.com/canela7/SportsLinkUp">
