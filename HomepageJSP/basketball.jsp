...
<body>
  ...
  <div class="w3-content" style="max-width:2000px; margin-top:46px">
    ...
    <div class="mySlides w3-display-container w3-center">
      <img src="./HomepageContent/img/Basketball-1.jpg" style="width:100%" height="450">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="app">
    ...
    <h1>Link Up!</h1>
    <a href="../Contact/ContactBasketballInfo.html" class="button">Create Basketball Event</a>
